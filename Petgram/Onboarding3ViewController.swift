...
class Onboarding3ViewController: UIViewController, PHPickerViewControllerDelegate {
    var pet: Pet?
    ...
    @IBAction func didTapContinueButton(_ sender: Any) {
        ...
        let profilePhotoFile = ParseFile(name: "PetProfilePhoto.jpg", data: photoData)
        
        pet?.profilePhoto = profilePhotoFile
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let nextViewController = segue.destination as? Onboarding4ViewController {
